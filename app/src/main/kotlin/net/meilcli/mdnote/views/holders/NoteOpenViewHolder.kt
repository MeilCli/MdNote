...
import kotlinx.android.synthetic.main.holder_note_open.*
import net.meilcli.mdnote.R
import net.meilcli.mdnote.models.NoteItem

class NoteOpenViewHolder private constructor(
    containerView: View
) : NoteViewHolder(containerView) {

    companion object {

        fun create(parent: ViewGroup): NoteOpenViewHolder {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.holder_note_open, parent, false)
            return NoteOpenViewHolder(itemView)
        }
    }
    ...
    override fun bind(element: NoteItem) {
        val openItem = element as NoteItem.Open // force cast
