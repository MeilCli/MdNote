...
class TestFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun create(value: Int): TestFragment {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return TextView(inflater.context).apply {
            text = "aaa: ${arguments?.getInt(key)}"
            setOnClickListener {
                val containerFragment = parentFragment as? ContainerFragment ?: return@setOnClickListener
                containerFragment.addFragment(create((arguments?.getInt(key) ?: -2) + 1))
            }
        }
    }
}